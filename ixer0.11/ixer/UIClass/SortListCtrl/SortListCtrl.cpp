...
int CSortListCtrl::AddItem( int j,LPCTSTR pszText, ... )
{
	const int iIndex = InsertItem( GetItemCount(), pszText ,j);
...
void CSortListCtrl::OnCustomDraw(NMHDR   *pnotify,   LRESULT   *result)   
{                 
